    ...
    <div class="container1">
        <div class="main-div">
            ...
            <form method="post" class="form-div" name="Login">
                <input type="text" name="name" placeholder="Faculty Name" required="true" style="text-transform: capitalize;">
                ...
                <div class="links">
                  <p> <a href="login.php">USER LOGIN</a>
                  /
...
window.history.replaceState(null,null,window.location.href);
    ...
    if (isset($_POST['submit'])) {
        ...
        $ret = mysqli_query($conn, "Select * FROM faculty WHERE username ='$faculty'");
