      ...
      <form action="add_content.php" method="post" enctype="multipart/form-data">
        ...
        <div class="selectwcourse">
          ...
          <select id="course" name="course" class="selectcourse" required>
            ...
            $courses = $conn->query("SELECT c_id, c_name FROM courses");
        ...
        <p>Enter unit content</p>
        <textarea cols="80" id="editor1" name="editor1" rows="10" style="height: 1751px;"></textarea>
...
if (isset($_POST["submit"])) {
  ...
  if ($conn->query($sql) === TRUE) {
    echo '<script>alert("Content inserted successfully into database."); window.location.href = "admin_dashboard.php";</script>';
  } else {
    echo "Error";
  }
}
